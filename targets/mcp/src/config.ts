...
export function loadServerConfig(
    ...
    return {
        ...
        bridgeHost,
        bridgePort,
        readOnly: parseBoolean(env.DIN_STUDIO_MCP_READ_ONLY),
        requestTimeoutMs: parseInteger(env.DIN_STUDIO_MCP_REQUEST_TIMEOUT_MS, 10_000),
        serverVersion: env.DIN_STUDIO_MCP_VERSION?.trim() || '0.1.0',
        tlsDirectory: resolvePath(
            process.cwd(),
            env.DIN_STUDIO_MCP_TLS_DIR?.trim() || '.din-studio-mcp/tls',
        ),
    };
}
