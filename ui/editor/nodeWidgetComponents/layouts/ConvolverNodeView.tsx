...
export const ConvolverNodeView = memo(({ id, data, selected }: NodeProps<Node<ConvolverNodeData>>) => {
    const convolverData = data;
        ...
        >
            ...
            <NodeWidget title={<NodeWidgetTitle icon="convolver">Impulse + normalize</NodeWidgetTitle>}>
                <AudioAssetPickerCard
                    ...
                    browseLabel="Browse impulse"
                    libraryQuery={libraryQuery}
                    onLibraryQuery={setLibraryQuery}
                    libraryPlaceholder="Search assets"
                    libraryTitle="Select one or more impulse response files"
                    assets={filteredAssets}
                    selectedAssetId={selectedImpulseId}
                    onLibrarySelect={handleLibrarySelect}
                    selectTitle="Select cached impulse response"
...
ConvolverNodeView.displayName = 'ConvolverNodeView';
