...
export const PianoRollNodeView: React.FC<NodeProps<Node<PianoRollNodeData>>> = memo(({ id, data, selected }) => {
    ...
    const baseNote = data.baseNote || 48;
...
PianoRollNodeView.displayName = 'PianoRollNodeView';
