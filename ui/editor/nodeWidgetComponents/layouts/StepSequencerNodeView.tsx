...
export const StepSequencerNodeView: React.FC<NodeProps<Node<StepSequencerNodeData>>> = memo(({ id, data, selected }) => {
...
StepSequencerNodeView.displayName = 'StepSequencerNodeView';
