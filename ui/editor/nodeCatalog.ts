...
export const EDITOR_NODE_CATALOG: NodeCatalogEntry[] = [
    ...
    { type: 'midiNote', category: 'MIDI', label: 'Piano / keys in', icon: '🎹', color: '#4dd4a0' },
    { type: 'midiCC', category: 'MIDI', label: 'Controllers (CC in)', icon: '🎛️', color: '#4dd4a0' },
...
/**
 * Compact reference for the AI agent system prompt — stays aligned with {@link DEFAULT_HANDLES_BY_TYPE}
 * and special cases in {@link getNodeHandleDescriptors}.
 */
